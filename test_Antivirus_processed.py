...
dict_colname_to_texname = {
    "memory_usage_Portal": "MUsaP",
    "cpu_usage_Portal": "CpuUsaP",
    "Physical_Memory_prct_used_Portal": "MUseP",
    "cpu_prct_used_Portal": "CpuUseP",
    "0_C_read_Portal": "RP",
    "memory_usage_VDI": "MUsaV",
    "cpu_usage_VDI": "CpuUsaV",
    "Physical_Memory_prct_used_VDI": "MUseV",
    "cpu_prct_used_VDI": "CpuUseV",
    "0_C_read_VDI": "RV",
    "X0_C_read_VDI": "RV",
    "Chargement_portail": "ChP",
    "Chargement_IE": "ChIE",
    "Default_Transaction": "T"
}
...
def run(param_method, param_tau_max, param_sig_level, param_dataset):
    param_method = param_method  #  NBCB_w NBCB_e GCMVL PCMCI PCGCE VarLiNGAM TiMINO Dynotears
    param_tau_max = param_tau_max
    param_sig_level = param_sig_level
    param_pre_processed_method = str(param_dataset)   # 1 2

    f1_adjacency_list = []
    f1_orientation_list = []
    percentage_of_detection_skeleton = 0

    param_data = pd.read_csv("data/Antivirus_Activity/preprocessed_" + param_pre_processed_method + ".csv", delimiter=',', index_col=0, header=0)
