...
dict_colname_to_texname = {
    "Cpu_php": "CpuPhp",
    "Net_In_Global": "NetInG",
    "Disque_write_global": "DiskW",
    "Ram_http": "RamHttp",
    "Net_Out_Global": "NetOutG",
    "Nb_connection_mysql": "NCM",
    "Nb_process_php": "NbProcessPhp",
    "Cpu_http": "CpuHttp",
    "Cpu_global": "CpuG",
    "Nb_process_http": "NbProcessHttp"
}


if __name__ == '__main__':
    param_method = "CBNB_e"  # CBNB_w CBNB_e NBCB_w NBCB_e GCMVL CCM PCMCI PCGCE VarLiNGAM TiMINO Dynotears
    param_tau_max = 3
    ...
    param_data = pd.read_csv("./data/Web_Activity/preprocessed_" + param_pre_processed_method + ".csv", delimiter=',', index_col=0, header=0)
