...
dict_colname_to_texname = {
    "publish_rate_causality_1": "P",
    "consumers_causality_1": "CON",
    "cpu_global_prct": "CPU",
    "ram_global_prct": "RAM",
    "messages_causality_1": "M",
    "disk_io_write_mega_byte": "DiskW",
...
if __name__ == '__main__':
    ...
    param_data = pd.read_csv("./data/Middleware_oriented_message_Activity/monitoring_metrics_" + param_dataset + ".csv", delimiter=',', index_col=0, header=0)
